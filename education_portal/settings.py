...
SECRET_KEY = 'django-insecure-u2oymrb@x@-$cgdjq20((n_y(z374g6@%c$e))a##89wsx#mbf'
...
CKEDITOR_CONFIGS = {
    "default": {
        ...
        "toolbar_Custom": [
            ...
            ["Link", "Unlink"],
            ["Image", "Table"],
            ["Mathjax"],            # ➜ the MathJax toolbar button
            ["Source"],
        ],
        "extraPlugins": "mathjax",  # ➜ enable MathJax plugin
        # Load MathJax from a CDN:
        "mathJaxLib": "https://cdn.jsdelivr.net/npm/mathjax@2/MathJax.js?config=TeX-AMS_HTML",
        # Optional: make the editor area larger
        "height": 300,
    }
}
